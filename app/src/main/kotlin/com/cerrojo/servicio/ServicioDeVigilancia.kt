...
class ServicioDeVigilancia : Service() {
    ...
    private fun comprobar() {
        ...
        for (paquete in almacen.appsVigiladas()) {
            ...
            // Solo al entrar en bloqueo: la vuelta es cada segundo y
            // relanzar la Activity 60 veces por minuto se comería la batería
            // y pisaría la cuenta atrás de los 45 s.
        ...
        if (ahora - ultimoAvisoDeLatido > 10_000L) {
            ultimoAvisoDeLatido = ahora
            val nm = getSystemService(NotificationManager::class.java)
            nm.notify(ID_NOTIFICACION, notificacion("vigilando · última comprobación ahora"))
        }
    }
